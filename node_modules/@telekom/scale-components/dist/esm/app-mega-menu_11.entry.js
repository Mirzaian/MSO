...
const Logo = class {
  ...
  render() {
    return (h(Host, null, h("style", null, this.size ? `:host { --logo-size: ${this.size}px; }` : '', this.styles), h("a", { href: this.href, part: this.getCssClassMap(), tabIndex: this.focusable === false ? -1 : 0, onFocus: () => {
        if (this.scrollIntoViewOnFocus === true) {
          window.scrollTo({ top: 0 });
        }
      }, title: this.logoTitle, "aria-describedby": this.logoAriaDescribedBy }, h("scale-logo-svg", { part: "icon", language: this.language, color: this.variant, accessibilityTitle: this.accessibilityTitle, role: "link" }))));
  }
  getCssClassMap() {

  ...
  render() {
    return (h(Host, null,
      ...
      h("a", { href: this.href, part: this.getCssClassMap(), tabIndex: this.focusable === false ? -1 : 0, onFocus: () => {
        ...
        }, title: this.logoTitle, "aria-describedby": this.logoAriaDescribedBy },
        h("scale-logo-svg", { part: "icon", language: this.language, color: this.variant, accessibilityTitle: this.accessibilityTitle, role: "link" }))));
  }
  getCssClassMap() {

...
export class Tooltip {
  ...
  render() {
    return (h(Host, { class: "host-container", part: "host-container", onKeyDown: this.handleKeyDown, onMouseOver: this.handleMouseOver, onMouseOut: this.handleMouseOut },
      this.styles && h("style", null, this.styles),
      h("div", { part: "slot-container" },
        h("slot", { onSlotchange: this.handleSlotChange })),
      !this.disabled && (h("div", { class: "tooltip-positioner", part: "tooltip-positioner", ref: (el) => (this.tooltipPositioner = el), onMouseOver: this.handleTooltipMouseOver },
        h("div", { class: {
            tooltip: true,
          ...
          h("div", { class: "content-wrapper", part: "content-wrapper", tabindex: 0 },

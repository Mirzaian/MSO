...
const renderIcon = require('./render-icon-95f2b685.js');
...
const Logo = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("style", null, this.size ? `:host { --logo-size: ${this.size}px; }` : '', this.styles), index.h("a", { href: this.href, part: this.getCssClassMap(), tabIndex: this.focusable === false ? -1 : 0, onFocus: () => {
        if (this.scrollIntoViewOnFocus === true) {
          window.scrollTo({ top: 0 });
        }
      }, title: this.logoTitle, "aria-describedby": this.logoAriaDescribedBy }, index.h("scale-logo-svg", { part: "icon", language: this.language, color: this.variant, accessibilityTitle: this.accessibilityTitle, role: "link" }))));
  }
  getCssClassMap() {
